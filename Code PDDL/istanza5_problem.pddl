...
(define (problem drone_1)
  ...
  (:objects
    drone1 drone2 - drone
    ord1 ord2 ord3 ord4 ord5 ord6 ord7 ord8 ord9 ord10 - order
  ...
  (:init
    ...
    (at drone2 p00)
    (is-restaurant p00)
    (is-recharge-station p26)
    (is-recharge-station p42)
   

    (at ord1 p00) (destination ord1 p46)
    (at ord2 p00) (destination ord2 p40)
    (at ord3 p00) (destination ord3 p06)
    (at ord4 p00) (destination ord4 p14)
    (at ord5 p00) (destination ord5 p35)
    (at ord6 p00) (destination ord6 p33)
    (at ord7 p00) (destination ord7 p35)
    (at ord8 p00) (destination ord8 p35)
    (at ord9 p00) (destination ord9 p06)
    (at ord10 p00) (destination ord10 p40)

    ;SETTING VARIABILI 
    (= (battery-level drone1) 40)
    (= (count-order drone1) 0)
    (= (max-order drone1) 3)
    (= (battery-level drone2) 40)
    (= (count-order drone2) 0)
    (= (max-order drone2) 3)
    (= (total-cost) 0)

    ;NO FLY ZONE (20-21-30-31)
